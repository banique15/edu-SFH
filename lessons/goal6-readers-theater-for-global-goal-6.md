...
## **Readers Theater for a Global Goal 6**

**(30-60 MINUTES)**

**Materials**

Selection of scripts or short plays centered around water and sanitation themes, tailored to age group

Copies of [scripts](https://docs.google.com/document/d/1J8cX34olrxxkvtpTjVBINUVmnFX7DkPyu4ibg00cmCM/edit?usp=drive_link) for each student, ideally with roles clearly marked
...
**Introduction**
**\
`	`Begin with a brief, impactful video clip showcasing either
...
**Script and Role Assignment**
**\
`	`Pre-select scripts aligned with Global Goal 6.
...
**\
`	`Begin by allowing students a short amount of time to read through their scripts, either individually or within their groups.
...
**\
`	`After all groups have performed, gather the class together for a comprehensive discussion that connects the individual performances to the broader themes of Global Goal 6. Ask questions such as:
