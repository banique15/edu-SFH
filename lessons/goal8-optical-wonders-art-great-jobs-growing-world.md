...
**(30-60 MINUTES)**  
**Materials**  
White drawing paper: Enough for each student to have at least one large sheet (e.g., 9x12 or 11x14 inches)  
Rulers  
Pencils  
Fine-tipped black markers or pens  
Colored pencils or markers  
Projector or whiteboard to display images/examples  
"Job Illusion" cards: Prepare small slips of paper or index cards (about 20-30 total) with concepts related to jobs, work, and the economy. One set per group required.  
Large display surface: Bulletin board, large poster board, or wall where the class's individual art pieces can be assembled into one large, collaborative installation.  
Tape  
...
Pens/Pencils  
**Introduction**  
Welcome students to an exciting art class. Explain that they will use their imagination and creativity to explore a really important idea: Global Goal 8, Decent Work and Economic Growth.  
...
**Warm Up: Seeing the Trick**  
Explain that the class will look at some simple optical illusions to warm up their eyes and brains for the Op Art they will create. Instruct them to observe the images carefully.  
...
**Job Illusion Card Sort**  
Divide students into small groups (3-4 students). Provide each group with one set (20-30 cards) of the Job Illusion Cards.  
...
**My Optical Message**  
Explain that each student will now create their own Op Art piece using one of the provided templates, inspired by the idea on their chosen Job Illusion Card. (Note: Depending on skill level, students may draw their own Op Art from scratch, using the templates as prompts or not at all. Adjust for your class's comfortability).  
...
**Gallery Walk and Explanation**  
Explain to the class they will now create a gallery with all the completed artworks. Instruct students to carefully place their finished artwork on desks, on the floor, or tape them to a designated wall space.  
