...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/about" | "/(app)/account" | "/(app)/account/edit" | "/(app)/curriculum" | "/(app)/goals" | "/(app)/goals/[slug]" | "/(app)/lessons" | "/(app)/lessons/[slug]" | "/(app)/signup" | "/(app)/subjects/[slug]"
