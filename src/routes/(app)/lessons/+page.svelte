							...
							<div class="flex items-start gap-2">
								<div class="flex-1 min-w-0">
									...
									<div class="flex gap-1.5 mt-1.5">
										...
										{/if}
										{#if formatGradeLevel(lesson.grade_level)}
											<span class="text-xs opacity-60">• {formatGradeLevel(lesson.grade_level)}</span>
										{/if}
									</div>
								</div>
						...
						<div class="flex items-start justify-between mb-2">
							<div class="flex-1">
								<div class="flex items-center gap-2 mb-2">
									...
									{#if formatGradeLevel($selectedLesson.grade_level)}
										<span class="text-xs text-base-content/60">{formatGradeLevel($selectedLesson.grade_level)}</span>
									{/if}
