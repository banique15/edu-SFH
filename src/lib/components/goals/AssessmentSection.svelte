<script lang="ts">
	import { extractQuestions, replaceLinksWithHtml, convertBoldToHtml } from '$lib/utils/content-parser';
	...
	const criteria = $derived(extractQuestions(section.content));
...
<section class="print:break-inside-avoid">
	...
	<!-- Content -->
	{#if !isCollapsed}
		<div id="assessment-content" class="px-0 py-5 print:block">
