...
const lessonContent: LessonContentData = {
	...
	materials: [
  {
    "name": "Simple percussion instruments (e.g., drums, shakers, tambourines, rhythm sticks, or improvised instruments like buckets, pots, and pans)",
    "isOptional": false
  },
  {
    "name": "Audio",
  ...
  {
    "name": "\\[Optional\\] lyrics or summaries of protest songs related to poverty and social justice",
    "isOptional": false
  }
],
	introduction: "",
	steps: [
  {
    "title": "Music and The Fight Against Poverty",
