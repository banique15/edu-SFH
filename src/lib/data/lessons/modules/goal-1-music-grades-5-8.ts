...
const lessonContent: LessonContentData = {
	...
	materials: [
  {
    "name": "Simple percussion instruments (e.g., drums, shakers, tambourines, rhythm sticks, or improvised instruments like buckets, pots, and pans) If instruments are limited, encourage students to find improvised instruments safely from the classroom (e.g., clapping hands, stomping feet, tapping pencils on desks, plastic containers as shakers, snapping fingers).",
    "isOptional": false
  },
  {
    "name": "Audio",
